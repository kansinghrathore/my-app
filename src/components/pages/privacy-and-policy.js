...
function Privcy(){
   const [page, setPage] = useState({}); 
      useEffect(()=>{
        let url = `${process.env.REACT_APP_API_ROOT_OPTION}/pages/2740`
    ...
    return( <>
    <SEO
          title='Privacy & Policy | Best Web Hosting Provider in INDIA | Logic Daddy'
  ...
  <div className="main-content">
   <div className="container">
      <div className="TermsAndConditon PrivacyTerms">
